...
/*
  ...
  // Verifier si le paramètre 'langue' existe avant de l'utiliser :
...
*/
 ...
 // C - Si l'utilisateur choisi une langue en cliquant un lien dans la navigation
 if(isset($_GET['langue'])) {
  $langueChoisie = $_GET['langue'];
  // C2 - Retenir le choix de langue de l'utilisateur (cookies)
...
<head>
  ...
  <title><?php echo $page ?> | Restaurant Leila</title>
  ...
  <div id="conteneur" class="page-<?php echo $page ?>">
    <header>
      ...
      <nav class="nav-principale">
        ...
        <a href="javascript: void(0);" title="<?= $en_altReservation; ?>">
