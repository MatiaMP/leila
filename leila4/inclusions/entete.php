  ...
  <div id="conteneur" class="page-<?php echo $page ?>">
    <header>
      <div class="barre-haut">
        ...
        ?>
        <nav class="i18n">
          <a href="index.php?langue=fr&couleur=bleu" class="actif" title="Français">fr</a>
          <a href="index.php?langue=en" title="English">en</a>
        </nav>
      </div>
      ...
      <div class="info-utile">
        ...
        <p class="addresse"><?= $en_addresse; ?></p>
